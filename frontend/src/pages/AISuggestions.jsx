  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.suggestions) {
        ...
        const suggestionsWithImages = response.data.suggestions.map(
          (suggestion) => ({
            ...suggestion,
            coverImage:
              suggestion.coverImage ||
              `/api/placeholder/${encodeURIComponent(suggestion.title)}`,
          })
        );
  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
      ...
      >
        ...
        >
          Tell our AI about your gaming preferences and get personalized
          recommendations with instant download links
        </p>
      </div>
          ...
          >
            ...
            >
              <p style={{ margin: 0, lineHeight: "1.6" }}>
                Hi! I'm your AI gaming assistant. Tell me about your gaming
                preferences and I'll recommend perfect games for you with
      ...
      {suggestions.length > 0 && (
        <div>
          ...
          >
            ...
            >
              Based on your preferences, I found {suggestions.length} amazing
              games you'll love
            </p>
          </div>
            ...
            {suggestions.map((suggestion, index) => (
              <div key={index} style={{ position: "relative" }}>
                ...
                >
                  ...
                  <div style={{ fontWeight: "400" }}>{suggestion.reason}</div>
                </div>
              </div>
            ))}
          </div>
